...
public class map extends chooselevel implements Initializable{
	...
	public void setmap() {
		...
		for(int i = 0; i < 7; i++) {
	      for(int j = 0; j < 11; j++) {
	       ...
	       else if(omap[i][j] == 21 || omap[i][j] == 22 || omap[i][j] == 23 || omap[i][j] == 24) {
	    	   if(omap[i][j] == 21) {
	    		   y1 = i;
	    		   x1 = j;
	    	   }
	...
	public EventHandler<KeyEvent> onKeyPressed = (e)->{
		...
		if(e.getCode() == KeyCode.UP && move == true){
			if(map2[b_y - 1][b_x] != 1) {
				if(map2[b_y - 1][b_x] != 21 && map2[b_y - 1][b_x] != 22 && map2[b_y - 1][b_x] != 23 && map2[b_y - 1][b_x] != 24){
					map2[b_y][b_x] = 0;
					b_y -= 1;
					step++;
		...
		if(e.getCode() == KeyCode.DOWN && move == true){
			if(map2[b_y + 1][b_x] != 1) {
				if(map2[b_y + 1][b_x] != 21 && map2[b_y + 1][b_x] != 22 && map2[b_y + 1][b_x] != 23 && map2[b_y + 1][b_x] != 24){
					map2[b_y][b_x] = 0;
					b_y += 1;
		...
		if(e.getCode() == KeyCode.LEFT && move == true){
			ivmap[y][x].setImage(b3);
			if(map2[b_y][b_x - 1] != 1) {
				if(map2[b_y][b_x - 1] != 21 && map2[b_y][b_x - 1] != 22 && map2[b_y][b_x - 1] != 23 && map2[b_y][b_x - 1] != 24){
					map2[b_y][b_x] = 0;
					b_x -= 1;
					step++;
					Step.setText("Step: " + Integer.toString(step));
		...
		if(e.getCode() == KeyCode.RIGHT && move == true) {
		...
		if(omap[c1_y][c1_x] == 3 && omap[c2_y][c2_x] == 3 && omap[c3_y][c3_x] == 3 && omap[c4_y][c4_x] == 3) {
