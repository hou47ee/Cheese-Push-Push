...
public class map2 extends chooselevel implements Initializable{
	@FXML
	ImageView star;
	...
	public EventHandler<KeyEvent> onKeyPressed = (e)->{
		...
		if(omap[c1_y][c1_x] == 3 && omap[c2_y][c2_x] == 3 && omap[c3_y][c3_x] == 3 && (omap[c4_y][c4_x] == 3 || omap[c4_y][c4_x] == 1) && (omap[c5_y][c5_x] == 3 || omap[c5_y][c5_x] == 1)) {
